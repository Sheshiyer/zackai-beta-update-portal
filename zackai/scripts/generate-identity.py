#!/usr/bin/env python3
"""
ZackAI — Brand Identity (2B Seal + 2C Logo)
...
PROMPT_2B = """ZackAI brand seal emblem. Embossed matte lilac circular seal
...
PROMPT_2C = """ZackAI embroidered-patch logo emboss. The brand sigil
