...
description: Spécification canonique, matériaux, points de sécurité et détails d’exécution
  pour le ZackAI hero product.
category: product
tags:
- product
- specifications
...
- **Nom :** ZackAI Smart Plush — Phantom Purple
- **Description :** compagnon d’apprentissage sans écran avec personnalité LED animée, douceur premium et logique sans abonnement.
- **Forme physique :** créature pelucheuse ronde, presque sphérique dans Muted Lilac (#AA98D6) avec oreilles félines pointues, visage crème/beige avec joues rosées, grands yeux LED bleus animés, synchronisés à la voix, à l’émotion et à l’humeur, petit sourire rouge, intérieur d’oreilles gris, fourrure hypoallergénique, recharge USB-C
